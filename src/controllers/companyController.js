  ...
  loginCompany: function (req, res) {
    ...
    model
      ...
      .then((responseQuery) => {
        ...
        if (compareresult == 0) {
          //zero mean has same value

          jwt.sign(
            { username: username_input, password: password_db },
      ...
      .catch((err) => {
        res
          ...
          .json({
            status: 404,
            message: "please insert the correct password or username",
          });
      });
        ...
        function (err, authData) {
          ...
          if (err) {
            ...
            res
              ...
              .json({
                status: 403,
                message: "your token has expired or destroyed",
              });
          } else {
            res.json({
