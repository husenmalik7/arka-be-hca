...
module.exports = {
    ...
    getByNameAndSkill: function(query){
        return new Promise (function(resolve, reject) {
            db.query(`select * from engineer where name like '%${query.name}%' and skill like '%${query.skill}%'`, function(err, response) {
                if (!err) {
                    resolve(response);
                } else {
                    reject(err);
    ...
    sortByName: function(){
        return new Promise (function(resolve, reject) {
            db.query('select * from engineer order by name', function(err, response) {
                if (!err) {
                    resolve(response)
                } else {
                    reject(err)
    ...
    sortBySkill: function(){
        return new Promise(function(resolve, reject) {
            db.query('select * from engineer order by skill', function(err, response){ 
                if (!err) {
                    resolve(response)
                } else {
                    reject(err)
    ...
    sortByDateUpdated: function(){
        return new Promise(function(resolve, reject) {
            db.query('select dateupdated from engineer order by dateupdated', function(err, response){
                if(!err) {
                    resolve(response)
                } else {
                    reject(err)
    ...
    getLimit: function(query){
        return new Promise(function(resolve, reject) {
            db.query(`select * from engineer limit ${query.limit} offset ${query.offset}`, function(err, response){ 
                if (!err){
                    resolve(response);
                } else {
                    reject(response);
